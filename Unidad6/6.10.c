/*6.10. Realizar una función que permita sumar 1 día a una fecha válida mostrando la fecha resultante. Si la fecha recibida no es válida
...
void sumaUnDiaAFecha(int* dia, int* mes, int* anio);
