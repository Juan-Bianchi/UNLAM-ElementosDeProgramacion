/*6.13. Realizar una función que permita restar n días a una fecha válida mostrando la fecha resultante. Si la fecha recibida no es válida
...
int main()
{
    ...
    printf("Ingrese los días a restar a la fecha: ");
